...
import com.fatec.fateats.data.model.mock.mockCategories

@Composable
fun CustomCategoryFilterChipList(
...
@Preview
@Composable
private fun CustomCategoryFilterChipListPreview() {
    CustomCategoryFilterChipList(
