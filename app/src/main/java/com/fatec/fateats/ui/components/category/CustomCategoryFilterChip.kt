package com.fatec.fateats.ui.components.category
...
import com.fatec.fateats.ui.theme.Gray300
...
@Preview
@Composable
private fun CustomCategoryFilterChipPreview() {
...
@Preview
@Composable
private fun CustomCategoryFilterChipNotSelectedPreview() {
    CustomCategoryFilterChip(
        category = Category(
            id = "1",
            name = "Cinema"
